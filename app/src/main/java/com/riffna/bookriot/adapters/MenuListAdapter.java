...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.book_menu_recycler_row, parent, false);
        ...
        holder.imageMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(total > 0 ) {
                    ...
                    clickListener.onUpdateClick(menu);
                    holder.tvCount.setText(total +"");
                } else {
                    holder.addMoreLayout.setVisibility(View.GONE);
                    holder.addToCartButton.setVisibility(View.VISIBLE);
                    menu.setTotalInCart(total);
                    clickListener.onRemoveClick(menu);
                }
            }
        });
    ...
    public interface MenuListClickListener {
        public void onAddClick(Menu menu);
        public void onUpdateClick(Menu menu);
        public void onRemoveClick(Menu menu);
    }
}
